...
Xtaum   = id_nemo.variables[vdic['NN_TAUM']][:,:,:]
id_nemo.close()
...
# Annual Curl:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xcurl_plot[0,:,:], Xmask, -0.3, 0.3, 0.05,
...
# JFM Curl:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xcurl_plot[1,:,:], Xmask, -0.3, 0.3, 0.05,
              corca=vdic['ORCA'], lkcont=False, cpal=CPAL_CURL,
...
# JAS Curl:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xcurl_plot[2,:,:], Xmask, -0.3, 0.3, 0.05,
              corca=vdic['ORCA'], lkcont=False, cpal=CPAL_CURL,
...
# Annual Taum:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xtaum_plot[0,:,:], Xmask, 0., 0.4, 0.025,
...
# JFM Taum:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xtaum_plot[1,:,:], Xmask, 0., 0.4, 0.025,
              corca=vdic['ORCA'], lkcont=False, cpal=CPAL_TAUM,
...
# JAS Taum:
bp.plot("2d")(xlon[0,:], xlat[:,ji_lat0], Xtaum_plot[2,:,:], Xmask, 0., 0.4, 0.025,
              corca=vdic['ORCA'], lkcont=False, cpal=CPAL_TAUM,
