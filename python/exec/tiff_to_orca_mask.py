...
vbasins = [   'pac'   ,    'atl' ,     'ind'  ,   'soc'   ,   'arc'  ,  'wed'    ,  'lab'    ,  'gin'   ]
vbnames = [ 'Pacific' , 'Atlantic' , 'Indian' , 'Southern', 'Arctic' , 'Weddell' , 'Labrador',   'GIN'  ]
vocesea = [ 'Ocean'   ,  'Ocean'   ,  'Ocean' ,  'Ocean'  ,  'Ocean' ,   'Sea'   ,   'Sea'   ,   'Seas' ]
vmandat = [  True     ,   True     ,   True   ,    False  ,    False ,   False   ,   False   ,   False  ] ; # Mandatory ?
