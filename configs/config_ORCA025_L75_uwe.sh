...
#
#      CONFIG: ORCA025 with 1050 y points ! (forget the old y=1021) 
#
...
export NEMO_OUT_STRCT="${STORE_DIR}/run/<RUN>-beskow/output/nemo"
...
export MM_FILE=/gpfs/projects/bsc32/bsc32325/ORCA025/ec-earth3.2/mesh_mask.nc4
export BM_FILE=/gpfs/projects/bsc32/bsc32325/ORCA025/ec-earth3.2/basin_mask.nc4

# 3D monthly climatologies of potential temperature and salinity (can be those you used for the NEMO run):
export F_T_CLIM_3D_12=${CONF_INI_DIR}/thetao_1degx1deg-ORCA025.L75_WOA2009_monthly_LB_20160223.nc4
export F_S_CLIM_3D_12=${CONF_INI_DIR}/so_1degx1deg-ORCA025.L75_WOA2009_monthly_LB_20160223.nc4
export SST_CLIM_12=${CONF_INI_DIR}/tos_180x360-ORCA025_Reynolds_monthly_mean1982-2005.nc4
export NN_T_CLIM="thetao"
export NN_S_CLIM="so"
export NN_SST_CLIM="tos"

export ICE_CLIM_12=${CONF_INI_DIR}/ice_cover_180x360-ORCA025_Hurrell_monthly_mean1980-1999.nc4
