...
#
# OCEAN MONITORING for NEMO v3.6 of EC-Earth 3.3.1 on 75 levels
#
...
export HOST="tetralith" ; # this has no importance at all, it will just become an "info" on the web-page!
export MASTERMIND="SMHI / K. Wyser" ; # same here, who's the person who designed/ran this simulation?
export EXTRA_CONF="NEMO 3.6 + LIM 3 (EC-Earth 3.3.1)" ;   #  // same here ...

# optional variable are $USERexp/$USER
export ${USERexp:=$USER}

export BASEDIR="/nobackup/rossby21/rossby/joint_exp/crescendo"
...
export NEMO_OUT_STRCT="$BASEDIR/ece-run/<EXP>/output/nemo"
export IFS_RUN_DIR="$BASEDIR/ece-run/<EXP>"

# Path to root directory where to save the diagnostics (diagnostics for this "CONF"):
export DIAG_DIR="$BASEDIR/barakuda/${CONF}_ece33"

# Path to directory containing some 2D and 3D climatologies on the relevant ORCA grid:
export CONF_INI_DIR="/nobackup/rossby18/sm_wyser/barakuda/ORCA1.L75_barakuda"
...
export PYTHON_HOME="/nobackup/rossby20/rossby/software/conda/tetralith/miniconda2/envs/barakuda" ; # HOME to python distribution with matplotlib and basemap !
...
#
export Y_INI_EC=1850 ;    # initial yearif ece_exp /= 0 !!!
...
export NEMO_SAVED_FILES="opa_grid_T_2D opa_grid_T_3D lim_grid_T_2D opa_grid_V_3D opa_grid_U_3D"
...
#
# Surface fluxes:
export FILE_FLX_SUFFIX="grid_T" ; # in what file type extension to find surface fluxes (normally: "SBC")
...
####           NN_QNET="qsr+qnsol"
# ++ Surface freswater fluxes: TEMPORARY SUPPRESSED
