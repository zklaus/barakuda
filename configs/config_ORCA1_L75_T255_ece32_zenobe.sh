...
export STORE_DIR="/SCRATCH/acad/ecearth/${USER}/"
...
export MM_FILE=/home/acad/ucl-elic/${USER}/ec-earth3.2_config_files/mesh_mask.nc4
export BM_FILE=/home/acad/ucl-elic/${USER}/ec-earth3.2/basin_mask.nc4
